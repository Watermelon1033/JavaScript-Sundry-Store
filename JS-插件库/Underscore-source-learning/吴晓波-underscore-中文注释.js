...
(function () {
     ...
     *       for (var index-css = 0; index-css < length; index-css++) {
     *           var currentKey = keys ? keys[index-css] : index-css;
     *           results[index-css] = iteratee(obj[currentKey], currentKey, obj);
     *       }
     *       return results;
     *   };
     * @returns {*}
